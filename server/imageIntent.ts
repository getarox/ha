...
const implicitCreateRequest = /^(?:صورة|صور|رسم|رسمة|لوحة|مشهد|خلفية|شعار|لوجو|بوستر|ملصق|image|picture|photo|drawing|illustration|artwork|logo|poster|wallpaper|visual|render)\s+(?:ل|عن|في|ب|من|على|مع|of|for|about|in|with)/i;
