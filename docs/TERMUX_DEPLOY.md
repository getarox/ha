...
كل أمر يتطلب شرطين مستقلين معًا: **موافقة الإصدار الحالي من اتفاقية الترخيص والاستخدام**، و**جلسة دخول حقيقية عبر Google أو Microsoft أو Apple**. رفض أي شرط يعيد `401` أو `428` ولا يصل الطلب إلى مزود الذكاء الاصطناعي أو الدفع.
